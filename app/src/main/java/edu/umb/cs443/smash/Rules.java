...
public class Rules extends Fragment {
    ...
    private void initBoard() {
        ...
        for (int i = 0; i < button.length; i++) {
            switch (a[i]) {
                case 0:
                    button[i].setBackgroundDrawable(getResources().getDrawable(R.drawable.light_blue));
                    break;
                case 1:
                    button[i].setBackgroundDrawable(getResources().getDrawable(R.drawable.red));
                    break;
                case 2:
                    button[i].setBackgroundDrawable(getResources().getDrawable(R.drawable.orange));
                    break;
                case 3:
                    button[i].setBackgroundDrawable(getResources().getDrawable(R.drawable.green));
                    break;
                case 4:
                    button[i].setBackgroundDrawable(getResources().getDrawable(R.drawable.blue));
                    break;
                case 5:
                    button[i].setBackgroundDrawable(getResources().getDrawable(R.drawable.yellow));
                    break;
                case 6:
                    button[i].setBackgroundDrawable(getResources().getDrawable(R.drawable.purple));
                    break;
            }
        }
        ...
        switch (color) {
            case 0:
                c_indi.setImageDrawable(getResources().getDrawable(R.drawable.light_blue));
                break;
            case 1:
                c_indi.setImageDrawable(getResources().getDrawable(R.drawable.red));
                break;
            case 2:
                c_indi.setImageDrawable(getResources().getDrawable(R.drawable.orange));
                break;
            case 3:
                c_indi.setImageDrawable(getResources().getDrawable(R.drawable.green));
                break;
            case 4:
                c_indi.setImageDrawable(getResources().getDrawable(R.drawable.blue));
                break;
            case 5:
                c_indi.setImageDrawable(getResources().getDrawable(R.drawable.yellow));
                break;
            case 6:
                c_indi.setImageDrawable(getResources().getDrawable(R.drawable.purple));
                break;
        }
    }
